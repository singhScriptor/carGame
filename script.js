...
var isAccelerating = false;  // Flag to track if the accelerator is pressed
...
// Modify the calcMovement function to account for button press
function calcMovement() {
    var move = $.state.speed * 0.01,
        newCurve = 0;
...
function calcMovement() {
    ...
    // Automatically adjust turn when no left/right is pressed
    ...
    // Handling the curve and road sections
    $.state.section -= $.state.speed;
